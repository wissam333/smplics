...
export default defineNuxtConfig({
  ...
  image: {
    provider: "ipx",
    domains: ["admin.nerva-online.com"],
    format: ["webp"],
    quality: 80,
  },
  aos: {
  ...
  app: {
    head: {
      ...
      link: [
        {
          rel: "icon",
          href: "/logo/logo-web.png",
          type: "image/x-icon",
        },
        {
          rel: "preconnect",
          href: "https://admin.nerva-online.com/",
          crossorigin: "",
        },
      ],
      script: [],
  ...
  runtimeConfig: {
    serverApiBase: "https://admin.nerva-online.com/",
    serverApi: {
    ...
    public: {
      apiBase: "https://admin.nerva-online.com/",
      api: {
        // Auth
