                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 mb-3 mb-lg-0">
                    <div class="d-flex flex-lg-column gap-2">
                      <button
                        @click="filterPrograms(true)"
                        class="btn btn-main-static2 w-100 text-start"
                        :class="{ active: filterOnline === true }"
                      >
                        <i class="bi bi-globe me-2"></i>
                        {{ locale === "ar" ? "أونلاين" : "Online" }}
                      </button>
                      <button
                        @click="filterPrograms(false)"
                        class="btn btn-main-static2 w-100 text-start"
                        :class="{ active: filterOnline === false }"
                      >
                        <i class="bi bi-building me-2"></i>
                        {{ locale === "ar" ? "حضوري" : "Onsite" }}
                      </button>
                    </div>
                  </div>

                  <!-- Programs List Column -->
                  <div class="col-lg-10 waves">
                    ...
                    <div class="mega-menu-section">
                      ...
                      <ul class="mega-menu-list row">
                        <li
                          ...
                          class="col-lg-2"
                        >
                          <nuxt-link :to="`/Products/${program.id}`">
...
.program-type.online:before {
  background: #38a169;
}

.program-type:not(.online):before {
  background: $second;
}
