...
const menuLinkColor = computed(() => (scrolled.value ? "#69acdf" : "#ffffff")); // Changed to $main on scroll
const socialIconColor = computed(() =>
  scrolled.value ? "#69acdf" : "#ffffff"
); // Changed to $main on scroll
const toggleColor = computed(() => (scrolled.value ? "#69acdf" : "#ffffff")); // Changed to $main on scroll
