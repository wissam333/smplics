...
.navCollapsed {
  ...
  .container {
    ...
    // --- CHANGED ---
    // Removed huge margin-top. Added padding-top to prevent logo touching screen edge.
    margin-top: 0;
    padding-top: 50px;
    // Removed border-top here, moved to .logoMob border-bottom
...
// --- CHANGED: New .logoMob styles ---
.logoMob {
  // Removed: position: absolute, top, right, left
  position: relative;

  width: 100%;

  // Replaces the border-top that was on .container
  border-bottom: 2px solid $second;

  // Add margin to push the menu down (simulating the old layout)
  margin-bottom: 20px;
  padding: 16px 21px;
  ...
  // Removed &.en block because Flexbox + Container padding
  // now handles the Left/Right positioning automatically.
}
