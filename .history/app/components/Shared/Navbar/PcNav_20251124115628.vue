  ...
  <div class="pc-nav-content">
    ...
    <div class="nav-links-and-aux">
      ...
      <div class="aux-group">
        ...
        >
          <a
            :href="props.social?.items[1]?.url"
            v-if="props.social?.items[1]?.isActive"
            target="_blank"
            class="Social-item"
          >
          ...
          <a
            :href="props.social?.items[0]?.url"
            v-if="props.social?.items[0]?.isActive"
            target="_blank"
            class="Social-item"
          >
          ...
          <a
            :href="props.social?.items[2]?.url"
            v-if="props.social?.items[2]?.isActive"
            target="_blank"
            class="Social-item"
          >
          ...
          <a
            :href="props.social?.items[3]?.url"
            v-if="props.social?.items[3]?.isActive"
            target="_blank"
            class="Social-item"
          >
