  ...
  <div class="navbar-wrapper">
    ...
    <div
      ...
      :class="{
        ...
        bodyAR: $i18n.locale === 'ar',
        bodyEN: $i18n.locale === 'en',
      }"
    >
...
.top {
  ...
  &:not(.scrolled) {
    ...
    top: 60px; // Adjust this value based on your contact bar height
  }
  ...
  @media (max-width: 991px) {
    ...
    &:not(.scrolled) {
      top: 70px; // Slightly higher for mobile if contact info takes more space
    }
  }
}
