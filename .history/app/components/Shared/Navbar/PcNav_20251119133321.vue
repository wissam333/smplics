<template>
  <div class="d-flex flex-column align-items-start w-100 cont">
    <!-- Pc -->
    <div class="d-flex justify-content-start align-items-end w-100 px-10">
      <div>
        <nuxt-link
          to="/"
          class="logo"
      ...
      <div
        class="d-flex justify-content-start align-items-end overflow-hidden px-6 links pb-2"
      >
        <div class="w-100">
          <div class="d-flex justify-content-between align-items-center">
            <ul class="d-flex flex-wrap mt-4">
              <li
                v-for="menu in useMenus().value.slice(0, 6)"
                :key="menu?.id"
                class="menu-item"
            ...
            <div class="d-flex justify-content-between align-items-center">
              <ul class="d-flex flex-wrap mt-4">
                <li
                  v-for="menu in useMenus().value.slice(6)"
                  :key="menu?.id"
                  class="menu-item"
                  v-show="menu.isActive"
                >
            ...
            <div
              v-if="Socials"
              class="d-flex justify-content-start align-items-start flex-column all-buttons"
            >
              <!-- social -->
              <div class="social-icons" :class="locale === 'ar' ? 'ar' : ''">
                ...
                >
                  <Icon
                    name="qlementine-icons:youtube-16"
                    size="25px"
                    color="#ffffff"
                  />
                </a>
