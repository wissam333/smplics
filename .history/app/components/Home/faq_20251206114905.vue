    ...
    <div class="container mx-auto px-4 md:px-8 relative z-10">
      ...
      <div class="text-center mb-16 max-w-3xl mx-auto">
        ...
        <h2 class="section-title fade-in" style="--delay: 0.2s">
          <Icon name="ph:sparkle-fill" class="accent-sparkle mx-1" />
          {{
            $i18n.locale === "ar"
              ? "الأسئلة الشائعة"
        ...
        <p class="section-subtitle fade-in" style="--delay: 0.3s">
          {{
            $i18n.locale === "ar"
              ? "ابحث عن إجابات سريعة للأسئلة الشائعة حول خدماتنا وعملياتنا"
              ...
              <div class="faq-header" @click="toggleFaq(item.id)">
                <div class="faq-question-content">
                  ...
                  <div class="faq-number">
                    {{
                      $i18n.locale === "ar"
                        ? String(filteredFaqItems.length - index).padStart(
                            2,
                            "0"
                          )
                  ...
                  <div class="faq-text-content">
                    <h3 class="faq-question">
                      {{
                        $i18n.locale === "ar" ? item.questionAr : item.question
                      }}
                    </h3>
                    <div class="faq-preview" v-if="!item.isOpen">
                      {{
                        truncateText(
                          $i18n.locale === "ar" ? item.answerAr : item.answer,
                          60
                        )
                      }}
                    </div>
                ...
                <div class="faq-content">
                  ...
                  <div class="faq-actions" v-if="item.actions">
                    ...
                    >
                      ...
                      <span>{{
                        $i18n.locale === "ar" ? action.labelAr : action.label
                      }}</span>
                    </button>
                  </div>
                </div>
...
const faqItems = ref([
  {
    ...
    questionAr: "ما هي سرعة استجابتكم للاستفسارات؟",
    answer:
    ...
    answerAr:
      "عادةً ما نرد على جميع الاستفسارات خلال 24 ساعة خلال أيام العمل. بالنسبة للمسائل العاجلة، يرجى الاتصال بخط الدعم مباشرة. فريقنا متاح من الاثنين إلى الجمعة من الساعة 9 صباحًا حتى 6 مساءً بتوقيت شرق الولايات المتحدة.",
    category: "general",
    isOpen: true,
    actions: [
      {
  ...
  },
  {
    ...
    answerAr:
      "نعم، نقدم استشارة أولية مجانية لمدة 30 دقيقة لفهم نطاق مشروعك واحتياجاتك الرقمية. وهذا يساعدنا على تقديم عرض مخصص يتوافق مع أهداف عملك وقيود ميزانيتك.",
    category: "services",
    isOpen: false,
    additionalInfo:
      "Consultations can be scheduled online through our booking system. Weekend slots are available upon request.",
    additionalInfoAr:
      "يمكن جدولة الاستشارات عبر الإنترنت من خلال نظام الحجز الخاص بنا. توجد فترات زمنية في عطلات نهاية الأسبوع عند الطلب.",
  },
  {
    id: 3,
    question: "What industries do you specialize in?",
    questionAr: "ما هي الصناعات التي تتخصصون فيها؟",
    answer:
    ...
    answerAr:
      "على الرغم من أننا غير مرتبطين بقطاع محدد، إلا أن لدينا خبرة واسعة في مجال التكنولوجيا المالية والتجارة الإلكترونية وبرامج الخدمة كبرنامج (SaaS) والخدمات المهنية بين الشركات. قوتنا الأساسية تكمن في بناء منصات قوية وقابلة للتطوير بغض النظر عن الصناعة.",
    category: "services",
    isOpen: false,
    additionalInfo:
      "We've successfully delivered over 50 projects across 15 different industries in the past 3 years.",
    additionalInfoAr:
      "لقد أنجزنا بنجاح أكثر من 50 مشروعًا عبر 15 صناعة مختلفة في السنوات الثلاث الماضية.",
  },
  {
    id: 4,
    question: "Can I visit your office for a meeting?",
    questionAr: "هل يمكنني زيارة مكتبكم لعقد اجتماع؟",
    answer:
    ...
    answerAr:
      "نعمل في المقام الأول عن بُعد للحفاظ على المرونة والأسعار التنافسية، ولكننا سعداء بجدولة اجتماعات شخصية لجلسات الانطلاق والتخطيط الاستراتيجي عند الطلب.",
    category: "general",
    isOpen: false,
    actions: [
      {
        label: "Book Meeting",
        labelAr: "احجز اجتماعًا",
        icon: "ph:calendar",
        action: "meeting",
      },
    ],
  },
  {
    ...
    questionAr: "ما هو الجدول الزمني النموذجي لمشروعكم؟",
    answer:
    ...
    answerAr:
      "تختلف الجداول الزمنية للمشروع بناءً على التعقيد. عادةً ما تستغرق مواقع الويب الصغيرة من 2 إلى 3 أسابيع، بينما يمكن أن تتراوح تطبيقات الويب المخصصة من 1 إلى 3 أشهر. نقدم جداول زمنية مفصلة خلال مرحلة تقديم العروض.",
    category: "services",
    isOpen: false,
  },
  {
    ...
    questionAr: "هل تقدمون صيانة مستمرة؟",
    answer:
    ...
    answerAr:
      "نعم، نقدم خطط صيانة شاملة تبدأ من 99 دولارًا شهريًا. وهذا يشمل تحديثات الأمان، ومراقبة الأداء، والنسخ الاحتياطية المنتظمة، وتحديثات المحتوى البسيطة.",
    category: "pricing",
    isOpen: false,
  },
  {
    ...
    questionAr: "ما هو هيكل الدفع الخاص بكم؟",
    answer:
      "We typically work on a 50% deposit and 50% upon completion basis for most projects. For larger projects, we can arrange milestone-based payments. All major credit cards and bank transfers are accepted.",
    answerAr:
      "عادةً ما نعمل على أساس دفعة أولى 50٪ و 50٪ عند الانتهاء لمعظم المشاريع. بالنسبة للمشاريع الأكبر، يمكننا ترتيب دفعات تعتمد على المعالم الرئيسية. نقبل جميع بطاقات الائتمان الرئيسية والتحويلات المصرفية.",
    category: "pricing",
    isOpen: false,
  },
  {
    ...
    questionAr: "هل تقدمون تدريبًا بعد اكتمال المشروع؟",
    answer:
      "Yes, we provide comprehensive training sessions for your team to ensure you can effectively manage and update your website. We also offer documentation and video tutorials for ongoing reference.",
    answerAr:
      "نعم، نقدم جلسات تدريبية شاملة لفريقك لضمان قدرتك على إدارة موقع الويب الخاص بك وتحديثه بشكل فعال. نقدم أيضًا توثيقًا ودروسًا فيديوية للرجوع إليها بشكل مستمر.",
    category: "services",
    isOpen: false,
  },
]);
