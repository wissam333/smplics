      ...
      <div class="text-center mb-16 max-w-5xl mx-auto">
        <div class="inline-block mb-4">
          <div class="accent-badge fade-in" style="--delay: 0.1s">
            {{ $t("testimonials.testimonials_subtitle") }}
          </div>
        </div>
        ...
        <h2 class="section-title fade-in" style="--delay: 0.2s">
          ...
          <span class="title-line">{{
            $t("testimonials.testimonials_title_1")
          }}</span>

          <span class="highlight-gradient">{{
            $t("testimonials.testimonials_title_2")
          }}</span>
        </h2>
      ...
      <div class="relative max-w-6xl mx-auto">
        ...
        <button class="custom-nav-btn prev-btn">
          <div class="nav-btn-content">
            ...
            <span class="nav-text">{{
              $t("testimonials.navigation.prev")
            }}</span>
          </div>
        </button>
        ...
        <div class="testimonial-carousel-wrapper fade-in" style="--delay: 0.4s">
          ...
          >
            <SwiperSlide
              v-for="(item, index) in translatedTestimonials"
              :key="index"
            >
                ...
                <div class="testimonial-card">
                  ...
                  <div class="card-footer">
                    <div class="project-info">
                      ...
                      <span>{{
                        $t("testimonials.card.successfully_completed")
                      }}</span>
                    </div>
                    <div class="date-info">
