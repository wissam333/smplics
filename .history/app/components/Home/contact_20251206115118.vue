<template>
  <section class="contact-section" :dir="direction">
    ...
    <div class="container">
      <!-- Simplified Header -->
      <div class="header">
        <div class="section-badge">{{ t("contact.title") }}</div>
        <h1 class="title">
          {{ t("contact.getInTouch") }}
          <span class="title-accent">{{ t("contact.withOurTeam") }}</span>
        </h1>
        <p class="description">
      ...
      <div class="content">
        ...
        <div class="info-card">
          <div class="card-header">
            <h3 class="card-title">{{ t("contact.contactInfo") }}</h3>
          </div>
          ...
          <div class="office-hours">
            <h4 class="hours-title">{{ t("contact.officeHours") }}</h4>
            <p class="hours-info">{{ t("contact.hoursInfo") }}</p>
          </div>

          <div class="social-section">
            <p class="social-title">{{ t("contact.followUs") }}</p>
          ...
          <div class="form-header">
            ...
            <div class="form-status">
              ...
              <span class="status-text"
                >{{ filledFields }}/4 {{ t("contact.completed") }}</span
              >
            </div>
          </div>
          ...
          <form @submit.prevent="handleSubmit" class="form">
            ...
            <div class="input-group">
              <div class="form-input">
                <input
                  ...
                  v-model="form.name"
                  required
                  :placeholder="$i18n.locale === 'ar' ? t('contact.yourName') : ' '"
                />
              ...
              <div class="form-input">
                <input
                  ...
                  required
                  :placeholder="
                    $i18n.locale === 'ar' ? t('contact.emailAddress') : ' '
                  "
                />
            ...
            <div class="form-input">
              <input
                ...
                id="phone"
                v-model="form.phone"
                :placeholder="$i18n.locale === 'ar' ? t('contact.phoneNumber') : ' '"
              />
              <label for="phone">{{ t("contact.phoneNumber") }}</label>
            </div>
            ...
            <div class="form-section">
              ...
              <div class="time-grid">
                <button
                  v-for="time in localizedTimeSlots"
                  :key="time"
                  type="button"
              ...
              <p class="help-text">{{ t("contact.selectTimeSlot") }}</p>
            </div>
    ...
    >
      <div class="modal" @click.stop>
        ...
        <h3 class="modal-title">{{ t("contact.messageSent") }}</h3>
        <p class="modal-text">
          {{ t("contact.thankYou") }}
        </p>
