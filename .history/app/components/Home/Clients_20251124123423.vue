    ...
    <div class="container-fluid">
      ...
      <div v-else class="marquee-wrapper">
        ...
        <div class="marquee-row">
          <ElementsMarquee :pause-on-hover="true" dir="ltr">
            <CardsClient
        ...
        <div class="marquee-row">
          <ElementsMarquee :reverse="true" :pause-on-hover="true" dir="ltr">
            <CardsClient
              v-for="client in clients"
              :key="`r2-${client.id}`"
              :client="client"
...
// State
const { data: clients, pending } = await useFetch(`${BASE_API}/api/blocks`, {
  query: {
    pageNumber: 0,
    pageSize: 20,
    orderBy: "RecordOrder",
