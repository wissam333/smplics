    ...
    <div class="container-fluid">
      ...
      <div v-else class="marquee-wrapper">
        ...
        <div class="marquee-row">
          <ElementsMarquee :duration="`30s`" :gap="`2rem`" pause-on-hover>
            <CardsClient
...
.marquee-row {
  ...
  // Fade effect on edges - now handled by the Marquee component's vignettes
  // but keeping this for additional masking if needed
