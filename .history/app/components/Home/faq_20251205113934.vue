<template>
  <section
    class="faq-section relative overflow-hidden py-24"
    ...
    <div class="container mx-auto px-4 md:px-8 relative z-10">
      ...
      <div class="text-center mb-16 max-w-3xl mx-auto">
        ...
        >
          ...
          <span
            class="text-accent font-semibold tracking-wider text-sm uppercase"
          >
      ...
      <div class="faq-container fade-in" style="--delay: 0.4s">
        ...
        <!-- CTA Section -->
        <div class="faq-cta fade-in" style="--delay: 0.8s">
          <div class="cta-content">
            <Icon name="ph:question" class="cta-icon" />
            <h3 class="cta-title">
              {{ $t("faq_cta_title", "Still have questions?") }}
            </h3>
            <p class="cta-text">
              {{
                $t(
                  "faq_cta_text",
                  "Our team is ready to help you with any additional queries"
                )
              }}
            </p>
            <button class="cta-btn" @click="$emit('contact')">
              <span>{{ $t("faq_cta_button", "Contact Support") }}</span>
