<template>
  ...
  >
    ...
    <div class="container mx-auto px-6 md:px-12 relative z-10"     data-aos="fade-up">
...
const tabs = [
  ...
  { id: "all", labelAr: "كل الخدمات", labelEn: "All Services" },
  { id: "dev", labelAr: "التطوير", labelEn: "Development" },
];
...
const services = [
  ...
  {
    id: 4,
    category: "dev", // Added to design for demo, usually Graphic Design is design
    title: "Web Development",
    description:
      "Fast. Scalable. Built with the latest tech. We develop websites that load fast, work everywhere, and grow with your business",
    offers: [
...
const servicesAr = [
  {
    ...
    description: "نصمم رحلات مستخدم سلسة وواضحة ومبنية للتحويل.",
    offers: [
      "بحث المستخدم",
      "الهيكلة السلكية",
      "النماذج الأولية",
  ...
  },
  {
    ...
    description:
      "علامة تجارية تتحدث قبل أن تفعل. نُنشئ أنظمة علامات تجارية متماسكة تترك انطباعاً دائماً.",
    offers: [
      "تصميم الشعار",
      "دليل الهوية",
  ...
  },
  {
    ...
    description: "تواصل بصري يجذب الانتباه وينقل رسالتك بفعالية.",
    offers: [
      "المواد المطبوعة",
      "الرسومات الرقمية",
  ...
  },
  {
    ...
    title: "تطوير الويب",
    description:
      "سريع. قابل للتطوير. مبني بأحدث التقنيات. نطور مواقع إلكترونية تُحمَل بسرعة، تعمل في كل مكان، وتنمو مع عملك.",
    offers: [
...
const filteredServices = computed(() => {
  if (activeTab.value === "all")
    return locale.value === "ar" ? servicesAr : services;
