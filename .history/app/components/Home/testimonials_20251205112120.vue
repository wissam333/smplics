<template>
  <section
    class="testimonials-section relative overflow-hidden py-20"
  ...
  >
    ...
    <div class="container mx-auto px-4 md:px-8 relative z-10 pt-10">
      <!-- Section Header -->
      ...
      <div class="relative max-w-6xl mx-auto">
        ...
        <!-- Stats Bar -->
        <div class="stats-bar fade-in" style="--delay: 0.8s">
          <div class="stat-item">
            <div class="stat-number">{{ testimonials.length }}+</div>
...
.testimonial-card {
  ...
  &:hover {
    ...
    box-shadow: 0 30px 60px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba($accent, 0.1);
  }
}
