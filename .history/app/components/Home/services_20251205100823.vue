...
const services = [
  {
    ...
    // Placeholders
    icon: "/images/icons/ui-ux-icon.png",
    bgImage: "/images/bgs/card-bg-1.png",
  },
  {
    id: 2,
    category: "design",
    ...
    icon: "/images/icons/brand-icon.png",
    bgImage: "/images/bgs/card-bg-2.png",
  },
  {
    id: 3,
    ...
    icon: "/images/icons/graphic-icon.png",
    bgImage: "/images/bgs/card-bg-3.png",
  },
];
