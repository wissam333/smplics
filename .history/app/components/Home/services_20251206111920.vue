        ...
        >
          ...
          <div class="card-content relative z-10">
            ...
            <div class="offer-section">
              <span class="offer-label">{{ $t("what_we_offer") }}</span>
              <ul class="offer-list" :class="{ 'text-right': locale === 'ar' }">
                <li v-for="(item, i) in service.offers" :key="i">
                  {{ $t(`services.${service.translationKey}.offers[${i}]`) }}
                </li>
              </ul>
            </div>
          </div>
...
const tabs = [
  { id: "design", translationKey: "design" },
  { id: "all", translationKey: "all_services" },
  { id: "dev", translationKey: "development" },
];
...
const services = [
  ...
  },
  {
    id: 4,
    category: "dev",
    translationKey: "web_development",
    icon: "/icon-3.webp",
    bgImage: "/bg-m.svg",
  },
];
