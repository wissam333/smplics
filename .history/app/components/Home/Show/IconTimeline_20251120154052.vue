...
.timeline-container {
  ...
  // ----------------------------------------------------
  // NEW: 3D effect for the entire timeline
  perspective: 1000px; 
  transform: rotateX(15deg); // Increased angle for a more visible effect
  // ----------------------------------------------------
}
...
// --- Animated Lines (STATIC) and Bullets (ANIMATED) ---
...
// Bullet 1: Outer Ring - Slower, Clockwise
.moving-bullet-1 {
    // Set transform-origin to the center of the orbit (the center of the parent)
    transform-origin: 50% $anim-line-1-radius; 
    animation: spin-clockwise 60s linear infinite; 
}

// Bullet 2: Inner Ring - Faster, Counter-Clockwise
.moving-bullet-2 {
    // Set transform-origin to the center of the orbit (the center of the parent)
