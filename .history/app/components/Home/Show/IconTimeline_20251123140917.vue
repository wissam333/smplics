...
$orbital-1-radius: $timeline-radius + 60px;
...
@keyframes electron-move-1 {
  0% {
    transform: translate(-50%, -50%) rotate(0deg) translateY(-$orbital-1-radius)
      rotate(0deg);
  }
  100% {
    transform: translate(-50%, -50%) rotate(360deg)
      translateY(-$orbital-1-radius) rotate(-360deg);
  }
}

@keyframes electron-move-2 {
  0% {
    transform: translate(-50%, -50%) rotate(0deg) translateY(-$orbital-2-radius)
      rotate(0deg);
  }
  100% {
    transform: translate(-50%, -50%) rotate(-360deg)
      translateY(-$orbital-2-radius) rotate(360deg);
  }
}

@keyframes electron-move-3 {
  0% {
    transform: translate(-50%, -50%) rotate(0deg) translateY(-$orbital-3-radius)
      rotate(0deg);
  }
  100% {
    transform: translate(-50%, -50%) rotate(360deg)
      translateY(-$orbital-3-radius) rotate(-360deg);
  }
}
...
.orbital-line {
  ...
  // Mobile optimizations for orbitals
  @media (max-width: $mobile-breakpoint) {
    &::before {
      filter: blur(0.5px);
    }
...
.orbital-1 {
  ...
  @media (max-width: $mobile-breakpoint) {
    width: ($timeline-radius-mobile + 60px) * 2;
    height: ($timeline-radius-mobile + 60px) * 2;
  }

  @media (max-width: $small-mobile-breakpoint) {
    width: ($timeline-radius-small-mobile + 45px) * 2;
    height: ($timeline-radius-small-mobile + 45px) * 2;
  }
}
