...
.timeline-container {
  ...
  // NEW: Global slow rotation for the whole system
  animation: spin-global 180s linear infinite; 
}
...
.timeline-text-display {
  ...
  // Important: Must reset transform here as the container is rotating (spin-global)
  ...
  // NEW: Radial gradient for nucleus depth
...
.moving-bullet-2 {
    ...
    // Initial box-shadow is managed by the pulse-glow animation
}
