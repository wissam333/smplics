...
// --- Animated Lines (STATIC ORBITS with distinct 3D rotations) ---
...
// Line 1: Outer Ring - Stronger X-tilt, now STATIC
.animated-line-1 {
    width: $anim-line-1-radius * 2;
    height: $anim-line-1-radius * 2;
    // Keep 3D tilt, but remove the animation
    transform: translate(-50%, -50%) rotateX(30deg); 
    // REMOVED: animation: spin-clockwise 120s linear infinite; 
}

// Line 2: Inner Ring - Y-axis rotation, now STATIC
.animated-line-2 {
    width: $anim-line-2-radius * 2;
    height: $anim-line-2-radius * 2;
    // Keep 3D tilt, but remove the animation
    transform: translate(-50%, -50%) rotateY(60deg);
    // REMOVED: animation: spin-counter-clockwise 100s linear infinite;
}

// Base styles for the bullets (Animation is still applied here)
.moving-bullet-1,
.moving-bullet-2 {
    width: $bullet-size;
    height: $bullet-size;
