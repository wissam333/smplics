...
.orbital-1 {
  ...
  border: 2px solid rgba(0, 0, 0, 0.6); // Red orbital
...
.orbital-2 {
  ...
  border: 2px solid #69acdfb9; // Teal orbital
...
.orbital-3 {
  ...
  border: 2px solid #f39200af; // Blue orbital
