...
@keyframes move-counter-clockwise {
  ...
  100% {
    transform: translate(-50%, -50%) rotate(-360deg)
      translateY(-$anim_line-2-radius) rotate(360deg);
  }
}
...
.moving-bullet-1 {
  animation: move-clockwise 10s linear infinite;
}

.moving-bullet-2 {
  animation: move-counter-clockwise 10s linear infinite;
}
