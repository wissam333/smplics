      ...
      <div class="stats-grid">
        ...
        >
          <div class="stat-card">
            ...
            >
              <div class="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-accent blur-xl"></div>
            </ElementsThreeDCardElement>
            ...
            >
              <div class="absolute -bottom-6 -left-6 w-24 h-24 rounded-full bg-accent blur-xl"></div>
            </ElementsThreeDCardElement>
...
<script setup>
import ThreeDCardContainer from '@/components/ThreeDCardContainer.vue';
import ThreeDCardElement from '@/components/ThreeDCardElement.vue';
