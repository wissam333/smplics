            ...
            <div class="logo-container">
              ...
              >
                <defs>
                  ...
                  <path id="ribbonPathData" d="M420 40 C 380 60, 320 120, 280 160 C 240 200, 180 230, 120 210 C 70 190, 80 120, 140 90 C 200 60, 280 160, 340 200 C 400 240, 480 200, 490 140 C 500 80, 450 20, 420 40 Z" />
                </defs>
